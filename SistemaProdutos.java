 ...
 * Usada para a demonstração as diversas funcionalidades do sistema.
 */
public class SistemaProdutos {
    ...
    private final Arvore<String, Produto> indicePorNome = new ArvoreAVL<>();

    // Instância do algoritmo de ordenação. Aqui foi usado o MergeSort.
    private final Ordenacao<Produto> ordenador = new MergeSort<>();

    /**
     * Método principal
     * Usado para execução de diversas demonstrações: anotação, regras de negócio, cadastro, CRUD,
    ...
    public static void main(String[] args) {
        ...
        // 2. Cadastra produtos para uso nos exemplos.
    ...
    /**
     * Criação e cadastro de produtos para teste de diferentes tipos (alimentício, artesanal).
     */
    private void cadastrarProdutosTeste() {
        ...
        System.out.println("##########################################################");
        try {
            // Instanciação de produtos diversos
            ...
            Produto produto3 = new ProdutoAlimenticio("C003", "Café Gourmet Moído", 45.90, "Alimentício", 80, "Sítio do VovÃ´", "2025-12-31");
            ...
            // Cadastro de cada produto nas estruturas do sistema
            ...
            // Caso regras de negócio não sejam satisfeitas, exibe mensagem de erro.
            System.err.println("Erro ao cadastrar produtos de teste: " + e.getMessage());
        }
    }

    /**
     * Demonstração das regras de negócio para cadastro de produtos,
     * forçando erros previsíveis para validar as exceções.
     */
    private void exibirRegrasDeNegocio() {
        System.out.println("\n\n#############################################################");
        System.out.println("### 1. DEMONSTRAÇÃO DE REGRAS DE NEGÓCIO (NegocioException)");
        System.out.println("#############################################################");
    ...
    /**
     * Demonstração das operações ligadas à árvore AVL:
    ...
    /**
     * Demonstrando ordenações usando MergeSort e imprimindo o tempo gasto em cada estratégia de comparação:
     * - Por nome do produto
     * - Por preço do produto
     * - Por categoria do produto
     * Também compara os tempos e destaca a eficiência da travessia em ordem da AVL.
     */
